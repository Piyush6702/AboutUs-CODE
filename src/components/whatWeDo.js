...
<h2>
 ...
 <div  className="cards-WhatweDo-div" >
   ...
   <div className="cards">
       ...
       We build a team of passionate developers to collaborate and contribute
        to open source projects, build applications and bring up innovative ideas.       </div>
   </div>
   <div className="cards">
   <img src={Gate} className="cardsImage" alt="devSvg"></img>
       <div className="cardsTitle">  Mentorship for Interviews</div>
       <div className="cardsDesc">
       Mentorship from experts who have cracked various interviews. Equipping candidates with skills to ace interviews.       </div>
   </div>
   <div className="cards">
   ...
   <img src={coding} className="cardsImage"  alt="devSvg"></img>
       ...
       <div className="cardsDesc">
       Making the students ready for the placement drives and recruitments under the guidance of our well placed seniors.       </div>
   </div>
   <div className="cards">
   <img src={coding} className="cardsImage"  alt="devSvg"></img>
